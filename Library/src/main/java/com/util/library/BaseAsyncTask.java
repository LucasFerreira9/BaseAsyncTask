...
public class BaseAsyncTask<T> {
    ...
    public BaseAsyncTask(DoInBackground<T> doInBackground, OnFinished<T> onFinished){
        this.doInBackground = doInBackground;
        this.onFinished = onFinished;
        this.mainHandler = new Handler(Looper.getMainLooper());
    }

    public BaseAsyncTask(DoInBackground<T> doInBackground, OnFinished<T> onFinished,OnExceptionListener onExceptionListener){
